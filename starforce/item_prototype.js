...
item.prototype.redraw_item_tooltip = function() {
    ...
    let html = `
        장비분류: ${this.idata.type.toUpperCase()} <br>
        ...
        업그레이드 가능 횟수: ${this.idata.hammers_added + this.idata.upgrades - this.idata.boosts.scroll_data.length} 
        <span class="item-color-recovery">(복구 가능 횟수: 0)</span> <br>
        적용된 망치: ${this.idata.hammers_added} ${this.idata.hammers_added == 10 ? "(MAX)" : ""}
        `: ""}
    `;
